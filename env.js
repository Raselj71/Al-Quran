 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.allquran.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.allquran'; // ios bundle id
const PACKAGE = 'com.allquran'; // android package name
const NAME = 'All Quran'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'AllQuran'; // app scheme
